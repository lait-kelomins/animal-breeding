...
- **Loved foods config** - Changing the taming foods for an animal will now make the animal follow you with those foods in hand
...
### Changed
- **Nametags on F key** - Nametags are now applied by pressing the F key (or Use hotkey)
...
- **Dead animals cleanup** - Removes dead animals from the tamed_animals.json file
